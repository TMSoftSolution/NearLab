...
class ReceivedNftAdapter(val context: Context, var clickCallback: (Data) -> Unit = {}) :
    ListAdapter<Data, ReceivedNftAdapter.StockViewHolder>(DiffCallback()) {
    ...
    inner class StockViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(product: Data) {
            ...
            description_text.text = "Receive from " + product.sender.email
