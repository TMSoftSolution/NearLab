...
@HiltViewModel
class ReceiveNftViewModel @Inject constructor(
    ...
    private val loginMutableLiveData = MutableLiveData<SendNftModel>()
    ...
    fun getAllDataMyNft() {
        ...
        viewModelScope.launch(exceptionHandler) {
            if (networkManager.isConnected) {
                ...
                httpClient.addInterceptor(Interceptor { chain ->
                    val request: Request =
                        chain.request().newBuilder()
                            .header("Authorization", preferenceHelper.authToken).build()
                ...
                val loginData = service.getDataReceiveNft()
    ...
    fun getMyNftMutableLiveData(): LiveData<SendNftModel> {
